...
parser.add_argument('--dataset_path', type=str, default='/home/lyd/ano_pred_cvpr2018/Data/', help='directory of data')
parser.add_argument('--dataset_type', type=str, default='ped2', help='type of dataset: ped2, avenue, shanghai')

args = parser.parse_args()

epoch = '115'
model_dir = '/home/lyd/DisPro-master/exp/' + args.dataset_type + '/log/epoch_' + epoch + '_model.pth'
m_items_dir = '/home/lyd/DisPro-master/exp/' + args.dataset_type + '/log/epoch_' + epoch + '_keys.pt'
